...
import { AvrMicrocontroller } from '../models/typeScript/avr-microcontroller';
import { MicrocontrollerPinConfiguaration } from '../models/typeScript/microcontroller-pin-configuration';
