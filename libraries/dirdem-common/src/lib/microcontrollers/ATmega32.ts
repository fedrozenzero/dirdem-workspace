    ...
    clockFrequencyOscillators: [
      {
        ...
        clockFrequencyOscillatorType:
          ClockFrequenciesOscillatorTypeEnum.Internal,
        clockFrequencyOscillatorMaterial:
          ClockFrequenciesOscillatorMaterialEnum.RC,
      },
      {
        clockFrequencyOscillatorValue: {
          frequencyValue: 2,
      ...
      },
      {
        ...
        clockFrequencyOscillatorType:
          ClockFrequenciesOscillatorTypeEnum.External,
        clockFrequencyOscillatorMaterial:
          ClockFrequenciesOscillatorMaterialEnum.Ceramic,
      },
      {
        clockFrequencyOscillatorRange: [
          {
        ...
        clockFrequencyOscillatorType:
          ClockFrequenciesOscillatorTypeEnum.External,
        clockFrequencyOscillatorMaterial:
          ClockFrequenciesOscillatorMaterialEnum.Crystal,
      },
      {
        clockFrequencyOscillatorRange: [
          {
  ...
  microcontrollerPinConfigurations: [
    {
      ...
      defaultPinCount: 40,
      pinoutImagesSrc: ['assets/images/ATmega32/ATmega32pinoutPDIP.png'],
      pins: [
        {
          number: 1,
          pinLabels: [PinLabelsEnum.PB0, PinLabelsEnum.T0, PinLabelsEnum.XCK],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 2,
          pinLabels: [PinLabelsEnum.PB1, PinLabelsEnum.T1],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 3,
        ...
        {
          number: 4,
          pinLabels: [PinLabelsEnum.PB3, PinLabelsEnum.OC0, PinLabelsEnum.AIN1],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 5,
          pinLabels: [PinLabelsEnum.PB4, PinLabelsEnum.SS],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 6,
          pinLabels: [PinLabelsEnum.PB5, PinLabelsEnum.MOSI],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 7,
          pinLabels: [PinLabelsEnum.PB6, PinLabelsEnum.MISO],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 8,
          pinLabels: [PinLabelsEnum.PB7, PinLabelsEnum.SCK],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 9,
          pinLabels: [PinLabelsEnum.RESET],
          pinType: PinTypesEnum.I,
        },
        {
          number: 10,
          pinLabels: [PinLabelsEnum.VCC],
          pinType: PinTypesEnum.I,
        },
        {
          number: 11,
          pinLabels: [PinLabelsEnum.GND],
          pinType: PinTypesEnum.I,
        },
        {
          number: 12,
          pinLabels: [PinLabelsEnum.XTAL2],
          pinType: PinTypesEnum.I,
        },
        {
          number: 13,
          pinLabels: [PinLabelsEnum.XTAL1],
          pinType: PinTypesEnum.I,
        },
        {
          number: 14,
          pinLabels: [PinLabelsEnum.PD0, PinLabelsEnum.RXD],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 15,
          pinLabels: [PinLabelsEnum.PD1, PinLabelsEnum.TXD],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 16,
          pinLabels: [PinLabelsEnum.PD2, PinLabelsEnum.INT0],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 17,
          pinLabels: [PinLabelsEnum.PD3, PinLabelsEnum.INT1],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 18,
          pinLabels: [PinLabelsEnum.PD4, PinLabelsEnum.OC1B],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 19,
          pinLabels: [PinLabelsEnum.PD5, PinLabelsEnum.OC1A],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 20,
          pinLabels: [PinLabelsEnum.PD6, PinLabelsEnum.ICP1],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 21,
          pinLabels: [PinLabelsEnum.PD7, PinLabelsEnum.OC2],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 22,
          pinLabels: [PinLabelsEnum.PC0, PinLabelsEnum.SCL],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 23,
          pinLabels: [PinLabelsEnum.PC1, PinLabelsEnum.SDA],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 24,
          pinLabels: [PinLabelsEnum.PC2, PinLabelsEnum.TCK],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 25,
          pinLabels: [PinLabelsEnum.PC3, PinLabelsEnum.TMS],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 26,
          pinLabels: [PinLabelsEnum.PC4, PinLabelsEnum.TDO],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 27,
          pinLabels: [PinLabelsEnum.PC5, PinLabelsEnum.TDI],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 28,
          pinLabels: [PinLabelsEnum.PC6, PinLabelsEnum.TOSC1],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 29,
          pinLabels: [PinLabelsEnum.PC7, PinLabelsEnum.TOSC2],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 30,
          pinLabels: [PinLabelsEnum.AVCC],
          pinType: PinTypesEnum.I,
        },
        {
          number: 31,
        ...
        {
          number: 32,
          pinLabels: [PinLabelsEnum.AREF],
          pinType: PinTypesEnum.I,
        },
        {
          number: 33,
          pinLabels: [PinLabelsEnum.PA7, PinLabelsEnum.ADC7],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 34,
          pinLabels: [PinLabelsEnum.PA6, PinLabelsEnum.ADC6],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 35,
          pinLabels: [PinLabelsEnum.PA5, PinLabelsEnum.ADC5],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 36,
          pinLabels: [PinLabelsEnum.PA4, PinLabelsEnum.ADC4],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 37,
          pinLabels: [PinLabelsEnum.PA3, PinLabelsEnum.ADC3],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 38,
          pinLabels: [PinLabelsEnum.PA2, PinLabelsEnum.ADC2],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 39,
          pinLabels: [PinLabelsEnum.PA1, PinLabelsEnum.ADC1],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 40,
          pinLabels: [PinLabelsEnum.PA0, PinLabelsEnum.ADC0],
          pinType: PinTypesEnum.IO,
        },
      ],
    },
    {
      ...
      defaultPinCount: 44,
      pinoutImagesSrc: ['assets/images/ATmega32/ATmega32pinoutTQFP.png'],
      pins: [
        {
          number: 1,
          pinLabels: [PinLabelsEnum.PB5, PinLabelsEnum.MOSI],
        ...
        {
          number: 40,
          pinLabels: [PinLabelsEnum.PB0, PinLabelsEnum.XCK, PinLabelsEnum.T0],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 41,
        ...
        {
          number: 43,
          pinLabels: [PinLabelsEnum.PB3, PinLabelsEnum.AIN1, PinLabelsEnum.OC0],
          pinType: PinTypesEnum.IO,
        },
        {
          number: 44,
...

    {
      ...
      defaultPinCount: 44,
      pinoutImagesSrc: ['assets/images/ATmega32/ATmega32pinoutMLF.png'],
      pins: [
        {
          number: 1,
          pinLabels: [PinLabelsEnum.PB5, PinLabelsEnum.MOSI],
